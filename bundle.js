var app = (function () {
	...
	/* src/components/Contador.html generated by Svelte v2.16.1 */

	const file$1 = "src/components/Contador.html";

	function create_main_fragment$1(component, ctx) {
		var div1, div0, text1, a, img, text2, script, current;

		return {
			c: function create() {
				div1 = createElement("div");
				div0 = createElement("div");
				div0.textContent = "Você é o visitante número";
				text1 = createText("\n  ");
				a = createElement("a");
				img = createElement("img");
				text2 = createText("\n    ");
				script = createElement("script");
				div0.className = "counter__text svelte-18srrn1";
				addLoc(div0, file$1, 1, 2, 24);
				img.src = "https://contador.s12.com.br/img-5ZZ72CBywZ37y33w-56.gif";
				img.border = "0";
				img.alt = "contador de acessos";
				addLoc(img, file$1, 3, 4, 128);
				a.href = "https://contador.s12.com.br";
				addLoc(a, file$1, 2, 2, 85);
				script.type = "text/javascript";
				script.src = "https://contador.s12.com.br/ad.js?id=5ZZ72CBywZ37y33w";
				addLoc(script, file$1, 4, 4, 241);
				div1.className = "counter svelte-18srrn1";
	...
	function Contador(options) {
		this._debugName = '<Contador>';
		if (!options || (!options.target && !options.root)) {
			throw new Error("'target' is a required option");
		}
	...
	assign(Contador.prototype, protoDev);

	Contador.prototype._checkReadOnly = function _checkReadOnly(newState) {
	};
	...
	const file$2 = "src/components/Sidebar.html";

	function create_main_fragment$2(component, ctx) {
		var div, img, text0, text1, current;
		...
		return {
			...
			o: function outro(outrocallback) {
				...
				if (contador) contador._fragment.o(outrocallback);
	...
	const file$3 = "src/components/Gallery.html";
	...
	const file$4 = "src/components/Content.html";
	...
	function create_main_fragment$5(component, ctx) {
		...
		return {
			c: function create() {
				...
				content._fragment.c();
				span0.className = "text svelte-1ci3kjk";
				addLoc(span0, file$5, 3, 33, 84);
				div0.className = "wordart rainbow svelte-1ci3kjk";
				addLoc(div0, file$5, 3, 4, 55);
				span1.className = "text svelte-1ci3kjk";
				addLoc(span1, file$5, 4, 31, 169);
				div1.className = "wordart blues svelte-1ci3kjk";
				addLoc(div1, file$5, 4, 4, 142);
				span2.className = "text svelte-1ci3kjk";
				addLoc(span2, file$5, 5, 35, 255);
				div2.className = "wordart superhero svelte-1ci3kjk";
				addLoc(div2, file$5, 5, 4, 224);
				div3.className = "title svelte-1ci3kjk";
				addLoc(div3, file$5, 2, 2, 31);
				div4.className = "header-mobile svelte-1ci3kjk";
				addLoc(div4, file$5, 1, 0, 1);
				img0.className = "icon__dance svelte-1ci3kjk";
				img0.src = "https://media.giphy.com/media/14kqI3Y4urS3rG/giphy.gif";
				img0.alt = "";
				addLoc(img0, file$5, 12, 4, 371);
				div5.className = "icon svelte-1ci3kjk";
				addLoc(div5, file$5, 11, 2, 348);
				span3.className = "text svelte-1ci3kjk";
				addLoc(span3, file$5, 15, 32, 528);
				div6.className = "wordart rainbow svelte-1ci3kjk";
				addLoc(div6, file$5, 15, 3, 499);
				span4.className = "text svelte-1ci3kjk";
				addLoc(span4, file$5, 16, 30, 612);
				div7.className = "wordart blues svelte-1ci3kjk";
				addLoc(div7, file$5, 16, 3, 585);
				span5.className = "text svelte-1ci3kjk";
				addLoc(span5, file$5, 17, 34, 697);
				div8.className = "wordart superhero svelte-1ci3kjk";
				addLoc(div8, file$5, 17, 3, 666);
				div9.className = "title svelte-1ci3kjk";
				addLoc(div9, file$5, 14, 2, 476);
				img1.className = "icon__dance svelte-1ci3kjk";
				img1.src = "https://media.giphy.com/media/14kqI3Y4urS3rG/giphy.gif";
				img1.alt = "";
				addLoc(img1, file$5, 20, 4, 782);
				div10.className = "icon svelte-1ci3kjk";
				addLoc(div10, file$5, 19, 2, 759);
				div11.className = "header svelte-1ci3kjk";
				addLoc(div11, file$5, 10, 0, 325);
				div12.className = "main_sidebar svelte-1ci3kjk";
				addLoc(div12, file$5, 24, 1, 912);
				div13.className = "main_content";
				addLoc(div13, file$5, 27, 1, 962);
				div14.className = "main svelte-1ci3kjk";
				addLoc(div14, file$5, 23, 0, 892);
			},
